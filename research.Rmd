...
The lab is working on a number of projects using maize and its wild realtives to understand the genetic basis of adaptation, asking questions such as:

#### Is adaptation mutation limited?
...
#### What kinds of loci are the most frequenct targets of adaptation?

* [Complex patterns of local adaptation in teosinte](http://gbe.oxfordjournals.org/content/5/9/1594)  
**Pyhäjärvi T**, **Hufford MB**, **Mezmouk S**, **Ross-Ibarra J**   

#### How often do different populations or taxa adapt using similar genetics?
