...
## Some fun inbreeding depression (ID) results
...
Today we (Markus Stetter) looked at GERP in the parents of Jim's pops, focusing only on segregating sites.  We see the same pattern as becore for number of deleterious sites:
