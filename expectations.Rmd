...
Attendance to regular weekly lab meetings is expected of all lab members. Participation in weekly lab coffee, Zeavolution and other regular meetings, and [journal club](jclub.html) is encouraged but not required. Note that if you are funded on one of the lab's current grants, you are expected to attend those meetings as well.  There are a number of seminars (Plant Biology, Genetics, Population Biology, Ecology & Evolution, Plant Sciences) each week, and these are usually posted in the office. You are  strongly encouraged to regularly go to one or more each week.
...
#### Authorship
We follow the [ICJME rules for authorship rules](http://www.icmje.org/recommendations/browse/roles-and-responsibilities/defining-the-role-of-authors-and-contributors.html):   
...
This section outlines RILab guidelines for using AI tools in research, writing, and coding. The expectations differ by experience level: what is appropriate for an expert may not be appropriate for a beginner, because part of training is learning to do the work yourself first. Your relevant experience level will likely differ for different tasks, so please use your best judgment and ask for clarification if you are unsure. The goal is to ensure that you are learning the skills you need to be a successful researcher, while also using AI tools responsibly.
