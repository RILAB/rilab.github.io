...
Attendance to regular weekly lab meetings is expected of all lab members. Participation in weekly lab coffee, [panzea](www.panzea.org) meetings, and [R.E.H.A.B.](rehab.html) is encouraged but not required. Note that if you are funded on one of the lab's current grants, you are expected to attend those meetings as well.  There are a number of seminars (Plant Biology, Genetics, Population Biology, Ecology & Evolution, Plant Sciences) each week, and these are usually posted in the office. You are  strongly encouraged to regularly go to one or more each week.
